/**
 * Created by macbook on 2017/12/9.
 * 输入：Data1
 * 输出：training_tfidfout
 */
...
//          System.out.println(entry.getKey().toString() + " == " + value);
    ...
    public static void main(String[] args) throws IOException {
        // 输入目录及输出目录
        String inputpath = "/Users/macbook/Downloads/Data1/";
        String outpath = "/Users/macbook/Downloads/train_tfidfout/";
        //创建"training_tfidfout"文件夹first
